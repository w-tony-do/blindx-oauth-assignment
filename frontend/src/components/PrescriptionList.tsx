import type { StoredPrescription, PrescriptionMedicine } from "@contract";
          ...
          return (
            <div key={prescription.id} className="prescription-card">
              <div className="prescription-header">
                ...
                <span
                  className={`status-badge status-${prescription.status.toLowerCase()}`}
                >
                  {prescription.status}
                </span>
              </div>
              ...
              <div className="prescription-body">
                <div className="prescription-info">
                  ...
                  <span>
                    {prescription.signaturerx_prescription_id || "Pending"}
                  </span>
                </div>
                ...
                <div className="medicines-list">
                  ...
                  <ul>
                    {medicines.map((med: PrescriptionMedicine, idx: number) => (
                      <li key={idx}>
